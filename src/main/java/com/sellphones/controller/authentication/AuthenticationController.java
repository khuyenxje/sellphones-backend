...
public class AuthenticationController {
    ...
    @PostMapping("/login")
    public ResponseEntity<CommonResponse> login(@RequestBody @Valid UserRequest userRequest, HttpServletResponse response){
    ...
    @PostMapping("/refresh")
    public ResponseEntity<CommonResponse> refreshToken(@CookieValue(AppConstants.USER_REFRESH_TOKEN_NAME) String refreshToken, HttpServletResponse response) {
    ...
    @PostMapping("/logout")
    public ResponseEntity<CommonResponse> logout(@RequestBody LogoutRequest logoutRequest, @CookieValue(AppConstants.USER_REFRESH_TOKEN_NAME) String refreshToken, HttpServletResponse response) {
        authenticationService.logout(logoutRequest, refreshToken);
        SecurityUtils.setRefreshTokenToCookie(response, "", AppConstants.USER_REFRESH_TOKEN_NAME);
